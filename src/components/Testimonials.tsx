    ...
    <section id="proven" className="section-padding bg-oiltac-dark text-white">
      <div className="container-custom">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12">
          <p className="text-lg">
            Validated in marine vessels, locomotives, and industrial power stations — with measurable results in efficiency, emissions, and engine condition.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
          <Card className="bg-white/20 backdrop-blur-sm border-0">
            <CardContent className="pt-6">
              ...
              <p className="italic mb-4 text-white font-medium">
                "Consistent improvement in fuel efficiency and a meaningful difference in engine cleanliness. The maintenance team noticed the difference right away."
              </p>
          ...
          <Card className="bg-white/20 backdrop-blur-sm border-0">
            <CardContent className="pt-6">
              ...
              <p className="italic mb-4 text-white font-medium">
                "Improved combustion stability, reduced black smoke, and cleaner injectors — without modifying the engine."
              </p>
              <div className="flex items-center">
                <div>
                  <p className="font-semibold text-white">Controlled Engine Test</p>
                  <p className="text-sm text-white/90">200-Hour Comparative Trial</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-white/80 text-sm">Hard, adhesive carbon deposits — difficult to remove</p>
            </div>
