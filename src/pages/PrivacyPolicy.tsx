...
const termlyHtmlContent = `
  <div data-custom-class="body">
    ...
    <ul><li data-custom-class="body_text" style="line-height: 1.5;"><span style="font-size: 15px; color: rgb(89, 89, 89);">Visit our website<bdt class="block-component"></bdt> at <a href="https://oiltacfuel.com" target="_blank" data-custom-class="link">https://oiltacfuel.com</a> or any website of ours that links to this Privacy Notice</li></ul>
